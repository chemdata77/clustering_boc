...
for k in data_dict.keys():
    ...
    # mean-shift
    label_unique = []
    bandwidth = estimate_bandwidth(X, quantile=0.5, n_jobs=-1,n_samples=10000, random_state=9)
...
plt.savefig('/data2/qzh/data_3.5/meanshift_0.5q/ms.jpg')
plt.show()

#with open('/data/bak/qzh/e2e_reaction_test/julei_mini/shuju/slht_fig_data_02.txt', 'wb') as fp:
    #pickle.dump(fig_data, fp) 
with open('/data2/qzh/data_3.5/meanshift_0.5q/clst_dict.dct', 'wb') as fp:
