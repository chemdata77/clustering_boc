...
#    print(best_T,best_B)
    ...
    y_pred = brc.fit_predict(X) 
    print(k, metrics.silhouette_score(X, y_pred, sample_size=1000), len(brc.subcluster_centers_))
    #fig_data.append(res)
...
#plt.savefig('/data2/qzh/data_3.5/birch_test/birch.jpg')
#plt.show()
#
#with open('/data2/qzh/data_3.5/birch_test/clst_dict_birch.dct', 'wb') as fp:
